...
class Test_AESCrypt(unittest.TestCase):
    ...
    def test_hash_passphrase(self):
        ...
        self.assertTrue("55ITBnbO1lxle02Ey/sjlalWDOnYzLFQN8+27HUlsZg=" == base64.b64encode(black_box.hash_passphrase(passphrase, salt)))
        ...
        passphrase = "tulip"
        #print "passphrase = ", passphrase
        self.assertTrue("T5POFcwZConeMtv9dYOHgMkOlXwq18xLTMfN1Sgc3Ik=" == base64.b64encode(black_box.hash_passphrase(passphrase,salt)))
